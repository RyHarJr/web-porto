      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row items-end justify-between mb-12 gap-6">
          <div className="space-y-4 max-w-2xl">
            ...
            <p className="text-muted-foreground md:text-lg">Check out some of our recent projects. We take pride in delivering high-quality, pixel-perfect websites.</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <motion.div key={index} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: index * 0.1 }} viewport={{ once: true }} className="group relative overflow-hidden rounded-xl bg-background border shadow-sm hover:shadow-xl transition-all">
        ...
        <div className="mt-8 text-center md:hidden">
          <Button onClick={() => window.open("https://github.com/RyHarJr/", "_blank")} variant="outline">
            View All Projects
          </Button>
        </div>
      </div>
